...
public final class Konfi {
    ...
    public static class Builder<T> implements PropertySourcesStep<T>, OptionsStep<T> {
        ...
        public T build() {
            ...
            var compositeRepository = Repositories.newCompositeRepository(repositories);
            compositeRepository.refresh();
            var handler = new KonfiHandler(propertyConverter, metadataMap, compositeRepository, preProcessors);
